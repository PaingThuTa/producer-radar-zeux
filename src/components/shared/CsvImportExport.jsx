...
const AUTO_ALIASES = {
  ...
  que_enviar: 'que_enviar', what_to_send: 'que_enviar', que_enviar_: 'que_enviar',
  donde_enviar: 'donde_enviar', where_to_send: 'donde_enviar', donde_enviar_: 'donde_enviar',
  relacion: 'relacion', relation: 'relacion', relación: 'relacion',
