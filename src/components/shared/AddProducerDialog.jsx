        ...
        <div className="p-5 space-y-4">
          <div>
            ...
            <Input value={data.name} onChange={e => setData({...data, name: e.target.value})}
              className="bg-[#0f0f10] border-[#27272a] text-white text-sm placeholder:text-[#52525b]" placeholder="Producer name" />
          </div>
          <div className="grid grid-cols-2 gap-3">
            <div>
              ...
              <Input value={data.instagram} onChange={e => setData({...data, instagram: e.target.value})}
                className="bg-[#0f0f10] border-[#27272a] text-white text-sm placeholder:text-[#52525b]" placeholder="@handle" />
            </div>
            <div>
              <label className="text-xs text-[#71717a] mb-1.5 block">Email</label>
              <Input value={data.email} onChange={e => setData({...data, email: e.target.value})}
                className="bg-[#0f0f10] border-[#27272a] text-white text-sm placeholder:text-[#52525b]" placeholder="email" />
            </div>
          </div>
          <div className="grid grid-cols-2 gap-3">
            <div>
              ...
              <Input value={data.style} onChange={e => setData({...data, style: e.target.value})}
                className="bg-[#0f0f10] border-[#27272a] text-white text-sm placeholder:text-[#52525b]" placeholder="e.g. Juice WRLD, Rod Wave..." />
            </div>
            <div>
              ...
              <Input type="number" min={1} max={maxPriority} value={data.priority}
                ...
                className="bg-[#0f0f10] border-[#27272a] text-white text-sm placeholder:text-[#52525b]" />
            </div>
          </div>
          {type === 'placement' && (
            <div>
              ...
              <Input value={data.song || ''} onChange={e => setData({...data, song: e.target.value})}
                className="bg-[#0f0f10] border-[#27272a] text-white text-sm placeholder:text-[#52525b]" placeholder="Song title" />
            </div>
          )}
        </div>
